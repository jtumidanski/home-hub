...
var ErrRawNameRequired = errors.New("raw ingredient name is required")
...
func (b *Builder) SetCanonicalIngredientID(id *uuid.UUID) *Builder {
	b.canonicalIngredientID = id
	return b
}
