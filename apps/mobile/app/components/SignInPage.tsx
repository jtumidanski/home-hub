      ...
      <div className="max-w-md w-full space-y-8 text-center">
        <div className="space-y-4">
          ...
          <p className="text-lg text-gray-600">
            Your household dashboard at a glance
          </p>
        </div>
        ...
        <div className="bg-white shadow-lg rounded-lg p-8 space-y-6 border border-gray-200">
          ...
          <div className="space-y-3">
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 w-full px-4 py-3 bg-gray-800 text-white border border-gray-800 rounded-lg hover:bg-gray-700 transition-colors"
            >
